...
function getBodyFromContextOrDocument(rawFileText, context) {
  ...
  const out = finalString.replace(/!\[.*\]\(.*\)/gi, "").replace(/#[a-zA-Z\d-_]*/gi, "").replace(/!\[\[.*\]\]/gi, "").replace(/```aat-vertical\n.*\n```/gi, "").trim();
  return out;
}
...
function getNoteTags(settings, metaData, tags) {
  let output = [];
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.hasLabel || $setup.hasDescription ? (openBlock(), createElementBlock("div", _hoisted_12, [
...
var _hoisted_14 = { class: "v-input-wrap v-checkbox" };
var _hoisted_24 = ["for"];
var _hoisted_32 = {
  key: 1,
  class: "setting-item-description"
...
var _hoisted_15 = { class: "v-grid-display" };
...
var _hoisted_42 = { class: "v-grid-display" };
...
var _hoisted_6 = { class: "v-grid-display" };
var _hoisted_7 = /* @__PURE__ */ createBaseVNode(
  "a",
  ...
  return openBlock(), createElementBlock("div", _hoisted_15, [
    ...
    createBaseVNode("section", _hoisted_42, [
      createVNode($setup["VHeader"], null, {
        default: withCtx(() => [
          createTextVNode(
            toDisplayString(_ctx.$t("settings.title.lookForTagsForTimeline")),
            1
            /* TEXT */
          )
        ]),
      ...
      createVNode($setup["VCheckbox"], {
        value: $props.value.lookForTagsForTimeline,
        "input-id": "look-for-tags-for-timeline",
        "onUpdate:value": _cache[0] || (_cache[0] = ($event) => $setup.emit("update:value", { lookForTagsForTimeline: $event }))
      }, {
        label: withCtx(() => [
          createTextVNode(
            toDisplayString(_ctx.$t("settings.label.lookForTagsForTimeline")),
            1
            /* TEXT */
          )
        ]),
        description: withCtx(() => [
          createTextVNode(
            toDisplayString(_ctx.$t("settings.description.lookForTagsForTimeline")),
            1
            /* TEXT */
          )
        ]),
...
var _hoisted_110 = { class: "warning v-warning-block v-grid-display" };
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("figure", _hoisted_110, [
...
function render15(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("section", _hoisted_113, [
    createVNode($setup["VInput"], {
...
function render18(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Transition, { mode: "out-in" }, {
    default: withCtx(() => [
      $setup.flowProgress === $setup.FlowState["not-started"] ? (openBlock(), createElementBlock("section", _hoisted_116, [
        createVNode(
          _component_i18n_t,
          {
...
function render19(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("article", _hoisted_117, [
    createVNode($setup["VHeader"], null, {
      default: withCtx(() => [
        createTextVNode(
